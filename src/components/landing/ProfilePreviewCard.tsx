...
export function ProfilePreviewCard() {
  ...
  useEffect(() => {
    ...
    const onChecklistChange = () => refreshPreview();
    window.addEventListener("focus", onFocus);
    window.addEventListener("zk-checklist-progress", onChecklistChange);
    return () => {
      window.removeEventListener("focus", onFocus);
      window.removeEventListener("zk-checklist-progress", onChecklistChange);
    };
  }, [refreshPreview]);

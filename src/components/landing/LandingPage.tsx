  ...
  return (
    <>
      <section className="hero-gradient relative min-h-[90vh] overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 pt-16 pb-24 lg:pt-20 lg:pb-28">
          <BlurTitle />

          <div className="mt-10 grid items-start gap-12 lg:mt-14 lg:grid-cols-[1fr_22rem] lg:gap-16 xl:grid-cols-[1fr_24rem]">
